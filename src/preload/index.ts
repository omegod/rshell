...
const api: RShellApi = {
  ...
  sessions: {
    ...
    sendInput: (sessionId: string, data: string) => ipcRenderer.invoke('sessions:send-input', sessionId, data),
    resize: (sessionId: string, size: TerminalSize) => ipcRenderer.invoke('sessions:resize', sessionId, size),
