...
const api: RShellApi = {
  ...
  files: {
    ...
    copy: (sessionId: string, srcPath: string, destPath: string) => ipcRenderer.invoke('files:copy', sessionId, srcPath, destPath),
    downloadDir: (sessionId: string, remotePath: string, localPath: string, transferId: string) => ipcRenderer.invoke('files:download-dir', sessionId, remotePath, localPath, transferId),
